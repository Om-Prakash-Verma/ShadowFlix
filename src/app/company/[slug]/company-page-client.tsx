...
export function CompanyPageContent({ companyId, companyName, initialData, totalPages: initialTotalPages }: CompanyPageContentProps) {
...
function CompanyResults({ companyId, initialData, initialTotalPages }: { companyId: string, initialData: MediaItem[], initialTotalPages: number }) {
